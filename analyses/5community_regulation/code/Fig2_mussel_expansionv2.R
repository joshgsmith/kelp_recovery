...
mus_el <- readxl::read_xlsx(file.path(basedir,"intertidal_monitoring/raw/mussel_elevation_data_20231019.xlsx"),sheet = 1)%>%
                    janitor::clean_names()
...
mus_pos_build1 <- mus_el %>% filter(latitude >= 36.47986 & latitude <= 36.64640) %>%
