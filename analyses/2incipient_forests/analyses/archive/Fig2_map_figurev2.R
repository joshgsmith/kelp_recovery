...
atos_area <- st_read(file.path(output, "landsat_atos_area_60_1000.geojson")) %>%
  mutate(site_numeric = as.numeric(site_num))

atos_poly <- st_read(file.path(basedir, "gis_data/processed/ATOS/ATOS_mpen_60msw_1000m.shp"))
