...
collect_site <- data.frame(
  longitude = c(-121.895458, -121.897094,-121.919409,-121.969176, -121.958694,-121.936567,-121.933743,-121.926676,-121.936555,-121.943408), # x-coordinate for the upper right corner
  latitude = c(36.611146, 36.614554,36.628443,36.567410, 36.561260, 36.554509, 36.538529,36.526489,36.524497,36.522504),  # y-coordinate for the upper right corner
  site_name = c("San Carlos", "Aquarium Reef","Otter Cove","Lone Cypress","Pescadero","Carmel Main","Carmel River","Monastery","Moss Cove","Bluefish Cove")
)
...
p3 <- ggplot() +
  ...
  labs(title = "2022 Q3 Canopy Cover")+
...
#save
ggsave(p3, filename = file.path(figdir, "field_sites.png"), 
